...
PayZen for OXID eShop CE is an open source plugin that links e-commerce websites based on OXID eShop CE to PayZen secured payment gateway developped by [Lyra Network](https://www.lyra-network.com/).
