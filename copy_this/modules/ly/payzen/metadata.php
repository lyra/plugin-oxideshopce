...
$aModule = array(
		...
		'title' 					=> 'PayZen',
		'description' => array(
				'en' => 'Module that links OXID eShop system with PayZen secured payment platform.<br />This module is compatible with PayZen <b>V2</b> platform.',
		...
		'files' => array(
				...
				'lyPayzenOrder' 		=> 'ly/payzen/controllers/lypayzenorder.php',
				'lyPayzenRedirect'		=> 'ly/payzen/controllers/lypayzenredirect.php',
				'lyPayzenResponse'		=> 'ly/payzen/controllers/lypayzenresponse.php',
				'lyPayzenOxOrder' 		=> 'ly/payzen/models/lypayzenoxorder.php',
				'lyPayzenoxPaymentList'	=> 'ly/payzen/models/lypayzenoxpaymentlist.php',

				'lyPayzenModule_Config' 	=> 'ly/payzen/controllers/admin/lypayzenmodule_config.php'
		),
		...
		'settings' => array(
				...
				array('group' => 'PAYMENT_PAGE', 'name' => 'VALIDATION_MODE', 'type' => 'select','constraints' => '|1|2', 'value' => '', 'position' => '4'),
				...
				array('group' => 'RETURN_TO_SHOP', 'name' => 'REDIRECT_SUCCESS_MESSAGE', 'type' => 'str', 'value' => 'Redirection vers la boutique dans quelques instants...', 'position' => '3'),
				array('group' => 'RETURN_TO_SHOP', 'name' => 'REDIRECT_ERROR_TIMEOUT', 'type' => 'str', 'value' => '5', 'position' => '4'),
				array('group' => 'RETURN_TO_SHOP', 'name' => 'REDIRECT_ERROR_MESSAGE', 'type' => 'str', 'value' => 'Redirection vers la boutique dans quelques instants...', 'position' => '5'),
